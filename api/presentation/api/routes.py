...
from api.presentation.api.v1 import user, table_maker, parametrs_form, summary_table, templates_router
...
router.include_router(parametrs_form.router, prefix="/parametrs_form", tags=["parametrs_form"])
