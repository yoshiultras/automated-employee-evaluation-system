...
from api.presentation.api.v1 import (
...
router.include_router(departments_metrics.router, tags=["departments_metrics"])
router.include_router(metrics_quartal.router, tags=["metrics_quartal"])